...
if(@WITH_SHADERC@)
  ...
  list(APPEND FFMPEG_LIBRARIES unofficial::shaderc::shaderc)
  if(vcpkg_no_avcodec_target AND TARGET FFmpeg::avcodec)
    target_link_libraries(FFmpeg::avcodec INTERFACE unofficial::shaderc::shaderc)
  endif()
endif()

if(@WITH_SVT_AV1@)
  pkg_check_modules(svt-av1 IMPORTED_TARGET svt-av1)
  list(APPEND FFMPEG_LIBRARIES PkgConfig::svt-av1)
  if(vcpkg_no_avcodec_target AND TARGET FFmpeg::avcodec)
    target_link_libraries(FFmpeg::avcodec INTERFACE PkgConfig::svt-av1)
  endif()
endif()

if(@WITH_PLACEBO@)
  pkg_check_modules(placebo IMPORTED_TARGET placebo)
  list(APPEND FFMPEG_LIBRARIES PkgConfig::placebo)
  if(vcpkg_no_avcodec_target AND TARGET FFmpeg::avcodec)
    target_link_libraries(FFmpeg::avcodec INTERFACE PkgConfig::placebo)
  endif()
endif()
